...
ActiveRecord::Schema[7.0].define(version: 2022_07_23_111234) do
  ...
  create_table "race_types", force: :cascade do |t|
    ...
    t.index ["name", "gender"], name: "index_race_types_on_name_and_gender", unique: true
  end
